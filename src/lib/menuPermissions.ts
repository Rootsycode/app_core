/**
 * Mapea los items del menú a recursos y acciones para validar permisos
 * Esta función es pura y no necesita ser server action
 */
export function getMenuResourceAction(menuLabel: string, menuLink?: string): {
  resource: string
  action: string
} | null {
  // Mapeo de labels del menú a recursos/acciones
